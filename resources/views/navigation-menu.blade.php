<div class="z-50 mx-auto px-3 py-4 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8">

    <div class="relative grid grid-cols-2 items-center lg:grid-cols-3">

            ...
            <div class="navbar p-12">
                ...
                <div class="flex-1">
                    <div class="flex flex-col">
                        <h1 class="bg-clip-text text-transparent bg-gradient-to-r from-accent to-secondary text-3xl font-bold">Bookmark-se</h1>
                        <p class="text-sm">
                            @if( $data =='stable')
              ...
              <div class="hero">
                <div class="hero-content text-center w-full max-w-full flex flex-col justify-center">
                    ...
                    <div role="tablist" class="tabs tabs-bordered w-full px-8 ">
                        ...
                        <div role="tabpanel" class="tab-content w-full p-10 ">
                            ...
                            <div class="flex justify-center gap-2">
                                <label class="input input-bordered input-primary w-8/12 flex items-center ">
                                  ...
                                  <button class="btn btn-primary uppercase font-bold">Search</button>
                            </div>
                        ...
                        <div role="tabpanel" class="tab-content p-10">
                            ...
                            <div class="flex justify-center gap-2">
                                <button class="btn  btn-wide" onclick="my_modal_5.showModal()">Edit Code</button>
                            ...
                            <div class="flex justify-center ">
                                <div class="mockup-code m-10 w-7/12 text-left p-4">
